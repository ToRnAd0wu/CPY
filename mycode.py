...
time_data = Label(font, text="Data View", color=0xFFFFFF, background_color=0x000000, max_glyphs=100)
time_data.x = TABS_X-5
time_data.y = TABS_Y+150
...
text_box(feed2_label, TABS_Y, 'Weather Station Data', 18)

text_box(sensors_label, TABS_Y,
         "Sensor Data", 28)

text_box(time_data, TABS_Y,
         time_str, 30)
